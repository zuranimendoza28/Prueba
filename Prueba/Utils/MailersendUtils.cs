...
namespace Prueba.Utils
{
    public class MailersendUtils
    {
         ...
         public async void EnviarCorreo(string email, DateTime date, string Names, string Name)
        {
            ...
            var emailMessage = new Email{
                ...
                text = $"¡Hello {Names} your registration date is: {date} and your course is: {Name}"
